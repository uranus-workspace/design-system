      ...
      <section className="mx-auto flex w-full max-w-5xl flex-col gap-10 px-6 py-28 text-white md:py-40">
        <header className="flex flex-col gap-4">
          ...
          <p className="max-w-2xl font-sans text-lg text-white/80 md:text-xl">
            Tokens, foundations, componentes e blocos prontos para produção.
            Construídos sobre shadcn/ui, Tailwind CSS v4 e Motion — alinhados à
            paleta cósmica e à tipografia Lexend Exa + Poppins definidas pelo
            manual de marca da{' '}
            <a
