...
| --- | --- | --- | --- |
| `OIDC_AUTHORITY` | `VITE_OIDC_AUTHORITY` | `NEXT_PUBLIC_OIDC_AUTHORITY` | Realm URL (ex.: `https://auth.example.com/realms/acme`). |
| `OIDC_CLIENT_ID` | `VITE_OIDC_CLIENT_ID` | `NEXT_PUBLIC_OIDC_CLIENT_ID` | Client público SPA (ex.: `acme-web`). |
