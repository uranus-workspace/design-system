...
export const gradients = {
  ...
  cosmic:
    'linear-gradient(135deg, #000000 0%, #000328 45%, #082d71 100%)',
  ...
  nebula:
    'linear-gradient(135deg, #000328 0%, #082d71 35%, #5dddfa 75%, #f8ddfc 100%)',
  // Galaxy: vertical fade from pure black to turquoise highlight.
  galaxy:
    'linear-gradient(180deg, #000000 0%, #000328 55%, #5dddfa 100%)',
  // Horizon: subtle top-down navy-to-deep gradient for surfaces/cards.
  horizon:
    'linear-gradient(180deg, #082d71 0%, #000328 100%)',
  // Halo: soft light lilac glow for highlights.
  halo:
    'radial-gradient(closest-side, #f8ddfc 0%, rgba(248,221,252,0) 80%)',
} as const;
